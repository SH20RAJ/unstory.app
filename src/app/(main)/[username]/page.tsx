...
export default function PublicProfilePage() {
  ...
  // Safe decode of username from URL
  const rawUsername = params?.username as string;
  const username = rawUsername ? decodeURIComponent(rawUsername).replace('@', '') : 'User';
          ...
          <div className="relative mb-12">
              ...
              <div className="px-6 flex flex-col md:flex-row items-end md:items-end gap-6 -mt-16">
                  ...
                  <div className="flex-1 pb-2">
                       ...
                       <p className="text-muted-foreground text-lg">@{username.toLowerCase()} • Computer Science '26</p>
                  </div>
                  ...
                  <Card className="bg-[#09090b] border-white/5">
                      ...
                      <CardContent className="space-y-4 text-sm text-muted-foreground">
                          ...
                          <div className="flex items-center gap-2">
                              ...
                              <a href="#" className="text-blue-400 hover:underline">github.com/{username}</a>
                          </div>
                          <div className="flex items-center gap-2">
