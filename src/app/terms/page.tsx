      ...
      <main className="pt-32 pb-20 px-6 max-w-4xl mx-auto">
         ...
         <div className="space-y-12 text-white/80 leading-relaxed text-lg">
             <section>
                 ...
                 <p>By accessing or using Unstory, you agree to be bound by these Terms. If you disagree with any part of the terms, then you may not access the Service.</p>
             </section>

             <section>
                 <h2 className="text-2xl font-bold text-white mb-4">2. Student Verification</h2>
                 <p>Unstory is exclusive to university students. You must verify your student status via a valid .edu email address. False representation of student status may result in immediate account termination.</p>
             </section>
             ...
             <section>
                 ...
                 <p>Unstory shall not be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits.</p>
             </section>
         </div>
      </main>
